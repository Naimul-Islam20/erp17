  ...
  return (
    <main className="bg-white">
      <section className="relative overflow-hidden bg-violet-50 pt-10 md:pt-14 pb-10 md:pb-20">
        ...
        />
        <div className="absolute -top-20 -left-20 w-64 h-64 bg-violet-200/40 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-1/2 -right-20 w-80 h-80 bg-fuchsia-200/30 rounded-full blur-3xl" />
        ...
        <div className="container relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            <div className="flex-1 space-y-6 text-center md:text-left">
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-violet-100 text-violet-800 text-xs md:text-sm font-bold uppercase tracking-wider mb-2">
                ERP17 · Invoicing
              </div>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                <button
                  type="button"
                  className="px-8 py-4 bg-violet-600 text-white font-bold rounded-2xl hover:bg-violet-700 shadow-xl shadow-violet-200 transition-all hover:scale-105 active:scale-95 text-sm md:text-base"
                >
                  Contact Us
                </button>
                <button
                  type="button"
                  className="px-8 py-4 bg-white text-violet-700 font-bold rounded-2xl border-2 border-violet-100 hover:bg-violet-50 transition-all text-sm md:text-base"
                >
                  View Demo
                </button>
              </div>
