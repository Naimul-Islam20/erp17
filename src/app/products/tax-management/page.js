...
const TaxManagementPage = () => {
  return (
    <main className="bg-white">
      ...
      <section className="relative overflow-hidden pt-10 md:pt-14 pb-10 md:pb-16">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(#e11d48 1.5px, transparent 1.5px)",
        ...
        <div className="absolute top-0 right-0 p-8 opacity-10 hidden lg:block">
          ...
          >
            <path
              ...
              fill="url(#paint0_linear_tax)"
            />
            <defs>
              <linearGradient
                id="paint0_linear_tax"
                x1="100"
                y1="0"
                x2="100"
                y2="200"
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            <div className="flex-1 space-y-6 text-center md:text-left">
              ...
              <p className="text-gray-600 text-base md:text-xl leading-relaxed max-w-2xl mx-auto md:mx-0">
                Simplify income tax calculations according to government policy.
                ERP17 automates tax rule setup, salary deductions, and
                investment tracking for complete peace of mind.
              </p>
        ...
        <div className="container space-y-24 md:space-y-32">
          {taxSections.map((sec, idx) => (
            ...
            >
              {/* Text Content */}
              <div
                className={`flex-1 space-y-6 text-center md:text-left order-2 ${sec.imgRight ? "md:order-1" : "md:order-2"}`}
              >
              ...
              {/* Image */}
              <div
                className={`flex-1 w-full order-1 ${sec.imgRight ? "md:order-2" : "md:order-1"}`}
              >
