          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            <div className="flex-1 space-y-6 text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                <button
                  type="button"
                  className="px-8 py-4 bg-sky-600 text-white font-bold rounded-2xl hover:bg-sky-700 shadow-xl shadow-sky-200 transition-all hover:scale-105 active:scale-95 text-sm md:text-base"
                >
                  Contact Us
                </button>
                <button
                  type="button"
                  className="px-8 py-4 bg-white text-sky-700 font-bold rounded-2xl border-2 border-sky-100 hover:bg-sky-50 transition-all text-sm md:text-base"
                >
                  View Demo
                </button>
              </div>
