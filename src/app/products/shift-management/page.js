...
const ShiftManagementPage = () => {
  return (
    <main className="bg-white">
      ...
      <section className="relative overflow-hidden pt-10 md:pt-6 pb-10 md:pb-16">
        ...
        <div className="absolute top-0 right-0 p-8 opacity-10 hidden lg:block">
          ...
          >
            <path
              ...
              fill="url(#paint0_linear_shift)"
            />
            <defs>
              <linearGradient
                id="paint0_linear_shift"
                x1="100"
                y1="0"
                x2="100"
                y2="200"
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            <div className="flex-1 space-y-6 text-center md:text-left">
              ...
              <p className="text-gray-600 text-base md:text-xl leading-relaxed max-w-2xl mx-auto md:mx-0">
                The ultimate solution for roster setup, shift duties, and
                attendance management. Streamline your company&apos;s workforce
                scheduling with ease using ERP17.
              </p>
