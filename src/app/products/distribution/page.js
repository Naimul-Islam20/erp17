...
const DistributionPage = () => {
  return (
    <main className="bg-white">
      <section className="relative overflow-hidden bg-blue-50 pt-10 md:pt-14 pb-10 md:pb-20">
        ...
        <div className="absolute top-1/2 -right-20 w-80 h-80 bg-sky-200/30 rounded-full blur-3xl" />
        ...
        <div className="container relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            <div className="flex-1 space-y-6 text-center md:text-left">
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-blue-100 text-blue-900 text-xs md:text-sm font-bold uppercase tracking-wider">
                ERP17 · Distribution
              </div>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                <button
                  type="button"
                  className="px-8 py-4 bg-blue-600 text-white font-bold rounded-2xl hover:bg-blue-700 shadow-xl shadow-blue-200 transition-all hover:scale-105 active:scale-95 text-sm md:text-base"
                >
                  Contact Us
                </button>
                <button
                  type="button"
                  className="px-8 py-4 bg-white text-blue-700 font-bold rounded-2xl border-2 border-blue-100 hover:bg-blue-50 transition-all text-sm md:text-base"
                >
                  View Demo
                </button>
              </div>
